...
class TeapotRenderer {
  ...
  static MATERIAL_PARAMETERS materials_[];
  static const int32_t NUM_MATERIALS;
 public:
  TeapotRenderer();
  ...
  void Unload();
  void UpdateViewport();
  void SetRoughness(const float f) {roughness_ = f;}
  void SwitchStage(const char* file_name);
